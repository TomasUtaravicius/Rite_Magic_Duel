...
public class LobbyMainPanel : MonoBehaviourPunCallbacks
{
    ...
    public void Awake()
    {
        ...
        {
            RejoinLobby(PhotonNetwork.LocalPlayer.NickName);
        }
    }
    ...
    public override void OnJoinedRoom()
    {
        ...
        foreach (Player p in PhotonNetwork.PlayerList)
        {
            ...
            if (p.CustomProperties.TryGetValue(RiteGame.PLAYER_READY, out isPlayerReady))
            {
        ...
        Hashtable props = new Hashtable
            {
                {RiteGame.PLAYER_LOADED_LEVEL, false}
            };
    ...
    public override void OnPlayerPropertiesUpdate(Player targetPlayer, Hashtable changedProps)
    {
        ...
        {
            object isPlayerReady;
            if (changedProps.TryGetValue(RiteGame.PLAYER_READY, out isPlayerReady))
            {
                entry.GetComponent<PlayerListEntry>().SetPlayerReady((bool)isPlayerReady);
            }
        }
